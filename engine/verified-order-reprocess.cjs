...
async function reprocessVerifiedOrder({proofStore,eventStore,outcomeStore,verifyOrder,orderKey=ORDER_KEY,attributionId=ATTRIBUTION_ID}={}){
 ...
 const result=await processOrderProof(proof,{proofStore,eventStore,outcomeStore,verifyOrder});
