...
const BASE_STATE_RESULTS = Object.freeze(['ELIGIBLE', 'STALE_BASE', 'FUTURE_BASE', 'INVALID_BASE']);
const REDUCER_RESULTS = Object.freeze(['APPLIED', 'NO_OP', 'REJECTED']);
const SINGLE_EVENT = 'SINGLE_EVENT';
const REPLAY_UPSTREAM = 'REPLAY_UPSTREAM';
const DEPENDENT_INVALIDATION_ATOMIC = 'DEPENDENT_INVALIDATION_ATOMIC';
...
const TRANSITION_PAYLOAD_KINDS = Object.freeze([
  'SCALAR_STRING', 'NULLABLE_STRING', 'STRING_ARRAY', 'VALUE_EVIDENCE',
  'QUALIFIER_OBJECT', 'OWNERSHIP_ENUM', 'GOVERNANCE_REFERENCE',
  'AUTHORIZATION_STATE', 'CONFLICT_CANDIDATES', 'INVALIDATION_FIELDS'
]);
const TRANSITION_BASE_RESULTS = Object.freeze(['ELIGIBLE', 'STALE_BASE', 'FUTURE_BASE', 'INVALID_BASE']);
const TRANSITION_REPLAY_RESULTS = Object.freeze(['EXACT_REPLAY', 'EVENT_ID_COLLISION', 'DISTINCT_EVENT', 'INVALID']);
...
module.exports = {
  ...
  TRANSITION_BASE_RESULTS,
  TRANSITION_REPLAY_RESULTS,
  PROVENANCE_SOURCE_TYPES,
  OWNERSHIP_STATES,
  AUTHORIZATION_STATUSES
};